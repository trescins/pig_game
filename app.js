...
- The player looses his current score when one of dice is a 1.
...
- You can set winning score previous start the game
    
*/

let scores, roundScore, activePlayer, gamePlaying, diceLast,winValue;
diceLast = 1;
...
document.querySelector('.btn-roll').addEventListener('click', function() {
   ...
   let dice2 = Math.floor(Math.random() * 6) + 1;
    ...
    if (dice !== 1 && dice2 !== 1) {
       ...
       // 4. IF player rolls TWICE 6,then LOST entire score        
...
function init () {
    ...
    roundScore = 0;
    gamePlaying = true;
    winValue = document.querySelector('.field-score').value;
